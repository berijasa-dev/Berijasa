...
export const HomeScreen: MainStackScreen<"HomeScreen"> = () => {
  const getUserQuery = trpc.getUser.useQuery({ name: "Mahmoud" });
        ...
        <ScrollView>
          ...
          <View>
            ...
            >
              ...
              >
                Do you need expert help for completing your projects? Or are you
                looking for the perfect opportunity to be self-empoyed? No
                matter what you need, Berijasa has got you covered!
              </Text>
              <TouchableOpacity
                style={{
              ...
              <TouchableOpacity
                style={{ marginTop: sh(23) }}
                onPress={() => {
                  createUserMutation.mutate({ name: "Roudain" });
                }}
              >
                <Text
                  style={{
            ...
            >
              <Ionicons name="logo-instagram" size={sh(24)} color={"#174953"} />
              <Ionicons
                name="logo-twitter"
                size={sh(24)}
                color={"#174953"}
              ...
              />
              <Ionicons name="logo-facebook" size={sh(24)} color={"#174953"} />
            </View>
          </View>
        </ScrollView>
      </SafeAreaView>
